...
description: Produce una evaluación breve de una propiedad sin subagentes, con señal preliminar, factores principales, limitaciones y próximo paso. Usar para `/realestate quick`, quick property snapshot o un gut-check inicial antes de análisis profundo.
---
