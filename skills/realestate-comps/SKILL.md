...
description: Busca y analiza ventas comparables recientes para estimar un rango de valor de mercado, documentar ajustes y evaluar el precio de una propiedad. Usar para `/realestate comps`, comparable sales, comp analysis, market value estimate o property comps; no presentar el resultado como appraisal.
---
