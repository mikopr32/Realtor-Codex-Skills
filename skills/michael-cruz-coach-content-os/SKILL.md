...
4. contenido final;
5. dirección visual o de grabación cuando aplique;
6. evidencia utilizada y campos pendientes;
7. CTA, automatización esperada y KPI;
8. puntuación de calidad;
9. estado `BORRADOR PARA APROBACIÓN`.
