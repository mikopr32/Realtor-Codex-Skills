...
description: Estima renta mediante comparables, construye un modelo de gastos y calcula cash flow, cap rate y cash-on-cash en escenarios conservador, base y optimista. Usar para `/realestate rental`, rental analysis, cash flow projection, rental income estimate o cap rate analysis.
---
